...
public class HTTPMethodsPractice {
    ...
    private static Geo newGeo = new Geo("46.2565", "37.9564");
    private static Address newAddress = new Address("Heroiv Ukrainy", "38/16", "MyCity", "72314", newGeo);
    private static Company newCompany = new Company("Super company", "Proactive didactic contingency",
            "harness real-time e-markets");
    private static User newUser = new User(35, "Andrii", "AndriiTheBest", "andrii.thebest@hero.com", newAddress,
            "+3804477444444", "best.com", newCompany);
    ...
    private static void createJsonWithName(String fileName, List items) throws IOException, InterruptedException {
        ...
        System.out.println("File is successfully created. Path: " + jsonFilePath);
    }
